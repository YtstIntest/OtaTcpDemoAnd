...
public class UpdateMessageAdapter extends BaseQuickAdapter<ArrayBean, BaseViewHolder> {


    public UpdateMessageAdapter(int layoutResId, @Nullable List<ArrayBean> data) {
